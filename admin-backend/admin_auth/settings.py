...
SECRET_KEY = 'django-insecure-admin-secret-key-2024-herbier-univ-man'
DEBUG = True
...
# Pour le développement, vous pouvez aussi autoriser toutes les origines
# CORS_ALLOW_ALL_ORIGINS = True  # Décommentez cette ligne si nécessaire
