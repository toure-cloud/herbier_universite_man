...
export default {
  ...
  methods: {
    ...
    goToVerify2FA() {
      ...
      // ✅ Stocker l'email dans le store et localStorage
    ...
    async handleRegister() {
      ...
      try {
        ...
        if (result.success) {
          ...
          // ✅ Message personnalisé indiquant l'envoi du code
          this.showSuccessModalMessage(
            'Votre compte a été créé avec succès ! ' +
            'Un code de vérification (OTP) a été envoyé à votre adresse email et téléphone. ' +
